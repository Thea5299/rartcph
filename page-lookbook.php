...
<style>
  ...
  #sec_1 {
        height: 500px;
        background-image: url("https://designtree.dk/rartcph/wp-content/themes/Divi-child/img/lookbooksplash.png");
...
<section id="sec_1" class="d-flex justify-content-center align-items-center">
      <div class="splash container-fluid">
          <div class="row">
              <div class="col">
                  <h1 class="headline text-center">LOOKBOOK</h1>
                  <p class="sub-header text-center fs-5">- Inspiration for your specialmade rug or mirror</p>
              </div>
          </div>
      </div>
      </section>
